            ...
            <div className='doing'>
                ...
                <ul className="doing-list">
                    {this.props.task_list.map((item) => {
                        return <ListItem description={item.description} finished={item.finished} key={"doing_"+ item.id} id={item.id} clickHandler={this.taskCompleteHandler} onDescpChange={this.props.onDescpChange}/>
                    })}
                </ul>
